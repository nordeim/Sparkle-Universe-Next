...
**Files**: Create `src/types/global.d.ts`

**Checklist:**
- [ ] Define Window.YT interface for YouTube API
- [ ] Define TimePeriod type correctly
- [ ] Define chart component prop types
- [ ] Define EdgeRuntime global
- [ ] Export necessary types for components

### Phase 2: Fix Service Layer
**Priority**: P1 (Critical)
**Files**: Update service files

**Checklist:**
- [ ] Fix EmailService import path in admin.service.ts
- [ ] Correct field names in analytics.service.ts (totalViews → viewCount)
- [ ] Fix function signatures in auth.service.ts
- [ ] Ensure all async functions return proper types
...
**Checklist:**
- [ ] Fix TimePeriod usage in dashboard
- [ ] Add missing analytics properties
- [ ] Fix YouTube embed button variants
...
### 3. Updated YouTube Embed Component
