...
- src/components/error-boundary.tsx (update original version shared below)
...
---
# original file: cat 'src/app/(main)/create/page.tsx'
```tsx
...
# original file: src/components/error-boundary.tsx
```tsx
