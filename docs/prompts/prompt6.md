you have done yet another awesome job! please keep up the good work! now help me carefully review the project's actual `prisma/schema.prisma` file below, then use line by line comparison of the `schema.prisma` against your latest revised `README.md` to identify any inconsistencies between them.
